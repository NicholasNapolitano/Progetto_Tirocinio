...
bool MapManager::init()
{
	...
	_player->setDestination(Point(957, 957));
	_player->setCrawlingStrategy(GO_TO_GOAL);
	...
	_enemy->setDestination(_enemy->getFirstDestination());
	...
	_enemy->setPosition(Point(200, 200));
	_enemy->setMapGame(this);
	_enemy->setMappa(this->getMap());
	_enemy->setTileMap(this->getTileMap());
	_enemy->setActualScene(EXPLORATION);
	_enemy->setActualWeapon(SNIPER);
	tile->addChild(_enemy, 5, "Enemy");*/
	...
	_enemy->setActualScene(EXPLORATION);
	_enemy->setActualWeapon(SNIPER);
	_enemy->setFirstDestination(Point(200, 100));
	_enemy->setSecondDestination(Point(200, 300));
	_enemy->setDestination(_enemy->getFirstDestination());
	tile->addChild(_enemy, 5, "Enemy");*/
	...
	_player->solve3((int)_player->getPosition().x, (int)_player->getPosition().y);
...
void MapManager::createMapI() {
	...
	int map[MAP_WIDTH][MAP_HEIGHT] = {
		...
		{ WALL, GOAL, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, WALL, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, WALL, GROUND, GROUND, GROUND, WALL },
		{ WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL }
	};
